        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Twitch',
              path: 'twitch',
              builder: (context, params) => TwitchWidget(),
            ),
            FFRoute(
              name: 'Facebook',
              path: 'facebook',
              builder: (context, params) => FacebookWidget(),
            ),
            FFRoute(
              name: 'Tempus_AI',
              path: 'tempusAI',
              builder: (context, params) => TempusAIWidget(),
            ),
            FFRoute(
              name: 'Youtube',
              path: 'youtube',
            ...
            FFRoute(
              ...
              path: 'instagram',
              requireAuth: true,
              builder: (context, params) => InstagramWidget(),
            ),
            FFRoute(
              name: 'faqs',
              path: 'faqs',
            ...
            FFRoute(
              name: 'TOSS',
              path: 'toss',
              builder: (context, params) => TossWidget(),
            ),
            FFRoute(
              name: 'privicy',
              path: 'privicy',
            ...
            FFRoute(
              name: 'Privicypolicy_2',
              path: 'privicypolicy2',
              builder: (context, params) => Privicypolicy2Widget(),
            ),
            FFRoute(
              name: 'T_O_S_2',
              path: 'tOS2',
              builder: (context, params) => TOS2Widget(),
            ),
            FFRoute(
              name: 'Account_2',
              path: 'account2',
