...
import 'priceings2_model.dart';
export 'priceings2_model.dart';

class Priceings2Widget extends StatefulWidget {
  const Priceings2Widget({Key? key}) : super(key: key);

  @override
  _Priceings2WidgetState createState() => _Priceings2WidgetState();
}

class _Priceings2WidgetState extends State<Priceings2Widget> {
  late Priceings2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Priceings2Model());

    _model.wLEmailController ??= TextEditingController();
    _model.wLEmailFocusNode ??= FocusNode();
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Welcome to Tempus Creators, where our dedicated team of developers is constantly enhancing our existing features and innovating new ones. If you\'d like to stay updated on our upcoming features, please join our email waitlist. By subscribing, you will receive an email notification whenever a new feature is on its way',
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                                                                style: FlutterFlowTheme.of(
